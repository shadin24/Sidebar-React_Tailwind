    ...
    <aside className="h-screen">
      <nav className="h-full flex flex-col bg-white border-r shadow-sm">
        ...
        <div className="border-t flex p-3">
          <img src="https://img.logoipsum.com/" className="w-10 h-10" />
          <div className={`flex justify-between items-center overflow-hidden transition-all ${expanded? "w-32" : "w-0"}`}>
            <div className="leading-4">
              <h4 className="font-semibold">SHADIN</h4>
              <span className="text-xs text-gray-600">
                shadinkvr2002@gmail.com
              </span>
            </div>
